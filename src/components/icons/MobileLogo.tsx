...
// Re-using the same SVG paths but as a distinct component for clarity
export const MobileLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    width="40"
    height="43.96"
    viewBox="0 0 363 399"
  ...
  >
    <defs>
      {/* 
        Using different IDs for the gradients ('m_') to ensure they are unique
        and don't conflict with the main Logo component if both were ever
        rendered on the same page by chance. This is a best practice.
      */}
      <linearGradient id="m_paint0_linear_0" x1="264.38" y1="53.7644" x2="45.98" y2="436.614" gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="m_paint1_linear_0" x1="288.51" y1="362.514" x2="46.98" y2="133.834" gradientUnits="userSpaceOnUse">
      ...
      <radialGradient id="m_paint2_radial_0" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(91.39 51.4944) scale(480.67)">
